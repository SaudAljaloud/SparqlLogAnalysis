...
public class CopyOfPrefixes {
	...
	static {
		...
		prefixes.put("office",	"urn:oasis:names:tc:opendocument:xmlns:office:1.0");
		...
		prefixes.put("opl-gs",	"http://www.openlinksw.com/schemas/getsatisfaction/");
		...
		prefixes.put("stock",	"http://xbrlontology.com/ontology/finance/stock_market#");
		...
		prefixes.put("usc",	"http://www.rdfabout.com/rdf/schema/uscensus/details/100pct/");
		...
		prefixes.put("wikicompany",	"http://dbpedia.openlinksw.com/wikicompany/");
